...
entity mac_vivado_dma64_w32_dataflow_in_loop_bat is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mac_vivado_dma64_w32_dataflow_in_loop_bat is 
    ...
    signal p_inbuff_0_V_i_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_inbuff_0_V_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_inbuff_1_V_i_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_inbuff_1_V_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_outbuff_0_V_i_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_outbuff_0_V_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_outbuff_1_V_i_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_outbuff_1_V_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal load32_U0_ap_start : STD_LOGIC;
    signal load32_U0_ap_done : STD_LOGIC;
    signal load32_U0_ap_continue : STD_LOGIC;
    signal load32_U0_ap_idle : STD_LOGIC;
    signal load32_U0_ap_ready : STD_LOGIC;
    signal load32_U0_p_inbuff_0_V_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal load32_U0_p_inbuff_0_V_ce0 : STD_LOGIC;
    signal load32_U0_p_inbuff_0_V_we0 : STD_LOGIC;
    signal load32_U0_p_inbuff_0_V_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal load32_U0_p_inbuff_1_V_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal load32_U0_p_inbuff_1_V_ce0 : STD_LOGIC;
    signal load32_U0_p_inbuff_1_V_we0 : STD_LOGIC;
    signal load32_U0_p_inbuff_1_V_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal load32_U0_in1_word_V_read : STD_LOGIC;
    signal load32_U0_load_ctrl : STD_LOGIC_VECTOR (95 downto 0);
    signal load32_U0_load_ctrl_ap_vld : STD_LOGIC;
    signal load32_U0_mac_vec_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal load32_U0_mac_vec_out_write : STD_LOGIC;
    signal load32_U0_mac_len_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal load32_U0_mac_len_out_write : STD_LOGIC;
    signal load32_U0_chunk_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal load32_U0_chunk_out_write : STD_LOGIC;
    signal load32_U0_conf_info_mac_n_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal load32_U0_conf_info_mac_n_out_write : STD_LOGIC;
    signal ap_channel_done_p_inbuff_1_V : STD_LOGIC;
    signal load32_U0_p_inbuff_1_V_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_p_inbuff_1_V : STD_LOGIC := '0';
    signal ap_sync_channel_write_p_inbuff_1_V : STD_LOGIC;
    signal ap_channel_done_p_inbuff_0_V : STD_LOGIC;
    signal load32_U0_p_inbuff_0_V_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_p_inbuff_0_V : STD_LOGIC := '0';
    signal ap_sync_channel_write_p_inbuff_0_V : STD_LOGIC;
    ...
    signal compute_U0_p_inbuff_0_V_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal compute_U0_p_inbuff_0_V_ce0 : STD_LOGIC;
    signal compute_U0_p_inbuff_1_V_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal compute_U0_p_inbuff_1_V_ce0 : STD_LOGIC;
    signal compute_U0_mac_vec_read : STD_LOGIC;
    signal compute_U0_mac_len_read : STD_LOGIC;
    signal compute_U0_p_outbuff_0_V_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal compute_U0_p_outbuff_0_V_ce0 : STD_LOGIC;
    signal compute_U0_p_outbuff_0_V_we0 : STD_LOGIC;
    signal compute_U0_p_outbuff_0_V_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal compute_U0_p_outbuff_1_V_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal compute_U0_p_outbuff_1_V_ce0 : STD_LOGIC;
    signal compute_U0_p_outbuff_1_V_we0 : STD_LOGIC;
    signal compute_U0_p_outbuff_1_V_d0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ap_channel_done_p_outbuff_1_V : STD_LOGIC;
    signal compute_U0_p_outbuff_1_V_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_p_outbuff_1_V : STD_LOGIC := '0';
    signal ap_sync_channel_write_p_outbuff_1_V : STD_LOGIC;
    signal ap_channel_done_p_outbuff_0_V : STD_LOGIC;
    signal compute_U0_p_outbuff_0_V_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_p_outbuff_0_V : STD_LOGIC := '0';
    signal ap_sync_channel_write_p_outbuff_0_V : STD_LOGIC;
    ...
    signal store_U0_p_outbuff_0_V_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal store_U0_p_outbuff_0_V_ce0 : STD_LOGIC;
    signal store_U0_p_outbuff_1_V_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal store_U0_p_outbuff_1_V_ce0 : STD_LOGIC;
    signal store_U0_out_word_V_din : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal p_inbuff_0_V_i_full_n : STD_LOGIC;
    signal p_inbuff_0_V_t_empty_n : STD_LOGIC;
    signal p_inbuff_1_V_i_full_n : STD_LOGIC;
    signal p_inbuff_1_V_t_empty_n : STD_LOGIC;
    signal p_outbuff_0_V_i_full_n : STD_LOGIC;
    signal p_outbuff_0_V_t_empty_n : STD_LOGIC;
    signal p_outbuff_1_V_i_full_n : STD_LOGIC;
    signal p_outbuff_1_V_t_empty_n : STD_LOGIC;
    ...
    signal load32_U0_start_full_n : STD_LOGIC;
    signal load32_U0_start_write : STD_LOGIC;
    ...
    component mac_vivado_dma64_w32_load32 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component mac_vivado_dma64_w32_compute IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component mac_vivado_dma64_w32_store IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component mac_vivado_dma64_w32_dataflow_in_loop_bkb IS
    generic (
        DataWidth : INTEGER;
    ...
    component mac_vivado_dma64_w32_dataflow_in_loop_dEe IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component mac_vivado_dma64_w32_fifo_w32_d2_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component mac_vivado_dma64_w32_fifo_w32_d3_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    p_inbuff_0_V_U : component mac_vivado_dma64_w32_dataflow_in_loop_bkb
    generic map (
        DataWidth => 32,
        AddressRange => 3200,
        AddressWidth => 12)
    ...
    p_inbuff_1_V_U : component mac_vivado_dma64_w32_dataflow_in_loop_bkb
    generic map (
        DataWidth => 32,
        AddressRange => 3200,
        AddressWidth => 12)
    ...
    p_outbuff_0_V_U : component mac_vivado_dma64_w32_dataflow_in_loop_dEe
    generic map (
        DataWidth => 32,
        AddressRange => 50,
        AddressWidth => 6)
    ...
    p_outbuff_1_V_U : component mac_vivado_dma64_w32_dataflow_in_loop_dEe
    generic map (
        DataWidth => 32,
        AddressRange => 50,
        AddressWidth => 6)
    ...
    load32_U0 : component mac_vivado_dma64_w32_load32
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    compute_U0 : component mac_vivado_dma64_w32_compute
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    store_U0 : component mac_vivado_dma64_w32_store
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    conf_info_mac_vec_c_U : component mac_vivado_dma64_w32_fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    conf_info_mac_len_c_U : component mac_vivado_dma64_w32_fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    b_0_c_U : component mac_vivado_dma64_w32_fifo_w32_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    conf_info_mac_n_c_U : component mac_vivado_dma64_w32_fifo_w32_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    conf_info_mac_vec_c1_1_U : component mac_vivado_dma64_w32_fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    conf_info_mac_len_c2_1_U : component mac_vivado_dma64_w32_fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_channel_write_p_inbuff_0_V_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_channel_write_p_inbuff_0_V <= ap_const_logic_0;
            else
                if (((load32_U0_ap_done and load32_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_p_inbuff_0_V <= ap_const_logic_0;
                else 
    ...
    ap_sync_reg_channel_write_p_inbuff_1_V_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    ap_sync_reg_channel_write_p_outbuff_0_V_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    ap_sync_reg_channel_write_p_outbuff_1_V_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    ap_channel_done_p_inbuff_0_V <= (load32_U0_ap_done and (ap_sync_reg_channel_write_p_inbuff_0_V xor ap_const_logic_1));
    ap_channel_done_p_inbuff_1_V <= (load32_U0_ap_done and (ap_sync_reg_channel_write_p_inbuff_1_V xor ap_const_logic_1));
    ap_channel_done_p_outbuff_0_V <= ((ap_sync_reg_channel_write_p_outbuff_0_V xor ap_const_logic_1) and compute_U0_ap_done);
    ap_channel_done_p_outbuff_1_V <= ((ap_sync_reg_channel_write_p_outbuff_1_V xor ap_const_logic_1) and compute_U0_ap_done);
    ap_done <= ap_sync_done;
    ap_idle <= (store_U0_ap_idle and load32_U0_ap_idle and (p_outbuff_1_V_t_empty_n xor ap_const_logic_1) and (p_outbuff_0_V_t_empty_n xor ap_const_logic_1) and (p_inbuff_1_V_t_empty_n xor ap_const_logic_1) and (p_inbuff_0_V_t_empty_n xor ap_const_logic_1) and compute_U0_ap_idle);
    ap_ready <= load32_U0_ap_ready;
    ap_sync_channel_write_p_inbuff_0_V <= ((load32_U0_p_inbuff_0_V_full_n and ap_channel_done_p_inbuff_0_V) or ap_sync_reg_channel_write_p_inbuff_0_V);
    ap_sync_channel_write_p_inbuff_1_V <= ((load32_U0_p_inbuff_1_V_full_n and ap_channel_done_p_inbuff_1_V) or ap_sync_reg_channel_write_p_inbuff_1_V);
    ap_sync_channel_write_p_outbuff_0_V <= ((compute_U0_p_outbuff_0_V_full_n and ap_channel_done_p_outbuff_0_V) or ap_sync_reg_channel_write_p_outbuff_0_V);
    ap_sync_channel_write_p_outbuff_1_V <= ((compute_U0_p_outbuff_1_V_full_n and ap_channel_done_p_outbuff_1_V) or ap_sync_reg_channel_write_p_outbuff_1_V);
    ap_sync_continue <= (ap_sync_done and ap_continue);
    ap_sync_done <= (store_U0_ap_done and load32_U0_ap_done);
    ap_sync_ready <= load32_U0_ap_ready;
    compute_U0_ap_continue <= (ap_sync_channel_write_p_outbuff_1_V and ap_sync_channel_write_p_outbuff_0_V);
    compute_U0_ap_start <= (p_inbuff_1_V_t_empty_n and p_inbuff_0_V_t_empty_n);
    compute_U0_p_outbuff_0_V_full_n <= p_outbuff_0_V_i_full_n;
    compute_U0_p_outbuff_1_V_full_n <= p_outbuff_1_V_i_full_n;
    compute_U0_start_full_n <= ap_const_logic_1;
    compute_U0_start_write <= ap_const_logic_0;
    in1_word_V_read <= load32_U0_in1_word_V_read;
    load32_U0_ap_continue <= (ap_sync_continue and ap_sync_channel_write_p_inbuff_1_V and ap_sync_channel_write_p_inbuff_0_V);
    load32_U0_ap_start <= ap_start;
    load32_U0_p_inbuff_0_V_full_n <= p_inbuff_0_V_i_full_n;
    load32_U0_p_inbuff_1_V_full_n <= p_inbuff_1_V_i_full_n;
    ...
    store_U0_ap_start <= (p_outbuff_1_V_t_empty_n and p_outbuff_0_V_t_empty_n);
