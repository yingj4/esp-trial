...
#ifndef _mac_vivado_dma64_w32_dataflow_in_loop_bkb_H_
#define _mac_vivado_dma64_w32_dataflow_in_loop_bkb_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore.h"

SC_MODULE(mac_vivado_dma64_w32_dataflow_in_loop_bkb) {
...
protected:
    ...
    mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore* mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U;
...
public:
    ...
    SC_CTOR(mac_vivado_dma64_w32_dataflow_in_loop_bkb) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U = new mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore("mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U");
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->clk      ( clk );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->reset    ( reset );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->ce0      ( i_ce0 );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->we0      ( i_we0 );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->address0 ( memcore_iaddr );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->d0       ( i_d0 );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->q0       ( i_q0 );

        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->ce1      ( t_ce0 );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->we1      ( t_we0 );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->address1 ( memcore_taddr );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->d1       ( t_d0 );
        mac_vivado_dma64_w32_dataflow_in_loop_bkb_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "mac_vivado_dma64_w32_dataflow_in_loop_bkb.trace");
            // ports
