...
set C_modelArgList {
	{ p_outbuff_0_V int 32 regular {array 50 { 1 3 } 1 1 }  }
	{ p_outbuff_1_V int 32 regular {array 50 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_outbuff_0_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "p_outbuff_1_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_outbuff_0_V_address0 sc_out sc_lv 6 signal 0 } 
	{ p_outbuff_0_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ p_outbuff_0_V_q0 sc_in sc_lv 32 signal 0 } 
	{ p_outbuff_1_V_address0 sc_out sc_lv 6 signal 1 } 
	{ p_outbuff_1_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ p_outbuff_1_V_q0 sc_in sc_lv 32 signal 1 } 
	{ out_word_V_din sc_out sc_lv 64 signal 2 } 
	{ out_word_V_full_n sc_in sc_logic 1 signal 2 } 
	{ out_word_V_write sc_out sc_logic 1 signal 2 } 
	{ mac_n_dout sc_in sc_lv 32 signal 3 } 
	{ mac_n_empty_n sc_in sc_logic 1 signal 3 } 
	{ mac_n_read sc_out sc_logic 1 signal 3 } 
	{ mac_vec_dout sc_in sc_lv 32 signal 4 } 
	{ mac_vec_empty_n sc_in sc_logic 1 signal 4 } 
	{ mac_vec_read sc_out sc_logic 1 signal 4 } 
	{ mac_len_dout sc_in sc_lv 32 signal 5 } 
	{ mac_len_empty_n sc_in sc_logic 1 signal 5 } 
	{ mac_len_read sc_out sc_logic 1 signal 5 } 
	...
	{ chunk_dout sc_in sc_lv 32 signal 7 } 
	{ chunk_empty_n sc_in sc_logic 1 signal 7 } 
	{ chunk_read sc_out sc_logic 1 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_outbuff_0_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "p_outbuff_0_V", "role": "q0" }} , 
 	...
 	{ "name": "p_outbuff_1_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "p_outbuff_1_V", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "p_outbuff_0_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "p_outbuff_1_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
...
set Spec2ImplPortList { 
	p_outbuff_0_V { ap_memory {  { p_outbuff_0_V_address0 mem_address 1 6 }  { p_outbuff_0_V_ce0 mem_ce 1 1 }  { p_outbuff_0_V_q0 mem_dout 0 32 } } }
	p_outbuff_1_V { ap_memory {  { p_outbuff_1_V_address0 mem_address 1 6 }  { p_outbuff_1_V_ce0 mem_ce 1 1 }  { p_outbuff_1_V_q0 mem_dout 0 32 } } }
