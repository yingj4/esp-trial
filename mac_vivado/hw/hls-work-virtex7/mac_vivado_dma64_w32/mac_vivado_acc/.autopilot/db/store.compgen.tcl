...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { p_outbuff_0_V_address0 { O 6 vector } p_outbuff_0_V_ce0 { O 1 bit } p_outbuff_0_V_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { p_outbuff_1_V_address0 { O 6 vector } p_outbuff_1_V_ce0 { O 1 bit } p_outbuff_1_V_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_mac_n \
    op interface \
    ports { mac_n_dout { I 32 vector } mac_n_empty_n { I 1 bit } mac_n_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_chunk \
    op interface \
    ports { chunk_dout { I 32 vector } chunk_empty_n { I 1 bit } chunk_read { O 1 bit } } \
} "
}
