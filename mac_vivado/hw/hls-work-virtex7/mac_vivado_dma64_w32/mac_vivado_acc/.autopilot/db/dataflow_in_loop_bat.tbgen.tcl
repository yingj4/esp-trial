...
set C_modelArgMapList {[ 
	{ "Name" : "in1_word_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "out_word_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ in1_word_V_dout sc_in sc_lv 64 signal 0 } 
	...
	{ out_word_V_din sc_out sc_lv 64 signal 5 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "7", "8", "10", "11", "12", "13", "14", "15"],
		...
		"Port" : [
			{"Name" : "in1_word_V", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "load32_U0", "Port" : "in1_word_V"}]},
			...
			{"Name" : "load_ctrl", "Type" : "HS", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "load32_U0", "Port" : "load_ctrl"}]},
			{"Name" : "b_0", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_word_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "store_U0", "Port" : "out_word_V"}]},
			{"Name" : "conf_info_mac_n", "Type" : "None", "Direction" : "I"},
			{"Name" : "store_ctrl", "Type" : "HS", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "store_U0", "Port" : "store_ctrl"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_inbuff_0_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_inbuff_1_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_outbuff_0_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_outbuff_1_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.load32_U0", "Parent" : "0", "Child" : ["6"],
		"CDFG" : "load32",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "p_inbuff_0_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "1"},
			{"Name" : "p_inbuff_1_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "2"},
			{"Name" : "in1_word_V", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
			...
			{"Name" : "conf_info_mac_n", "Type" : "None", "Direction" : "I"},
			{"Name" : "mac_vec_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "10",
				"BlockSignal" : [
					{"Name" : "mac_vec_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_len_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "11",
				"BlockSignal" : [
					{"Name" : "mac_len_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "chunk_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "12",
				"BlockSignal" : [
					{"Name" : "chunk_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "conf_info_mac_n_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "13",
				"BlockSignal" : [
					{"Name" : "conf_info_mac_n_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.load32_U0.regslice_forward_load_ctrl_U", "Parent" : "5"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.compute_U0", "Parent" : "0",
		"CDFG" : "compute",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "p_inbuff_0_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "5", "DependentChan" : "1"},
			{"Name" : "p_inbuff_1_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "5", "DependentChan" : "2"},
			{"Name" : "mac_vec", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "5", "DependentChan" : "10",
				"BlockSignal" : [
					{"Name" : "mac_vec_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_len", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "5", "DependentChan" : "11",
				"BlockSignal" : [
					{"Name" : "mac_len_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_outbuff_0_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "3"},
			{"Name" : "p_outbuff_1_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "4"},
			{"Name" : "mac_vec_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "14",
				"BlockSignal" : [
					{"Name" : "mac_vec_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_len_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "15",
				"BlockSignal" : [
					{"Name" : "mac_len_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.store_U0", "Parent" : "0", "Child" : ["9"],
		"CDFG" : "store",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "p_outbuff_0_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "7", "DependentChan" : "3"},
			{"Name" : "p_outbuff_1_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "7", "DependentChan" : "4"},
			{"Name" : "out_word_V", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "out_word_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_n", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "5", "DependentChan" : "13",
				"BlockSignal" : [
					{"Name" : "mac_n_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_vec", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "7", "DependentChan" : "14",
				"BlockSignal" : [
					{"Name" : "mac_vec_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_len", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "7", "DependentChan" : "15",
				"BlockSignal" : [
					{"Name" : "mac_len_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "store_ctrl", "Type" : "HS", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "store_ctrl_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "chunk", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "5", "DependentChan" : "12",
				"BlockSignal" : [
					{"Name" : "chunk_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.store_U0.regslice_forward_store_ctrl_U", "Parent" : "8"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conf_info_mac_vec_c_U", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conf_info_mac_len_c_U", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.b_0_c_U", "Parent" : "0"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conf_info_mac_n_c_U", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conf_info_mac_vec_c1_1_U", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conf_info_mac_len_c2_1_U", "Parent" : "0"}]}
