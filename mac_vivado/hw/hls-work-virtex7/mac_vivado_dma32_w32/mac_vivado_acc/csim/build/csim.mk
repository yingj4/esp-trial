...
$(ObjDir)/tb.o: ../../../../../tb/tb.cc $(ObjDir)/.dir
	...
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I../../../../../inc -Wno-unknown-pragmas -DDMA_SIZE=32 -DDATA_BITWIDTH=32 -std=c++0x -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb.d

$(ObjDir)/espacc.o: ../../../../../src/espacc.cc $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/espacc.cc in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I../../../../../inc -DDMA_SIZE=32 -DDATA_BITWIDTH=32 -std=c++0x  $(IFLAG) $(DFLAG) $< -o $@ ; \
