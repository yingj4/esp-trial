...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p_inbuff_V \
    op interface \
    ports { p_inbuff_V_address0 { O 13 vector } p_inbuff_V_ce0 { O 1 bit } p_inbuff_V_q0 { I 32 vector } p_inbuff_V_address1 { O 13 vector } p_inbuff_V_ce1 { O 1 bit } p_inbuff_V_q1 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename p_outbuff_V \
    op interface \
    ports { p_outbuff_V_address0 { O 7 vector } p_outbuff_V_ce0 { O 1 bit } p_outbuff_V_we0 { O 1 bit } p_outbuff_V_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'p_outbuff_V'"
}
}
