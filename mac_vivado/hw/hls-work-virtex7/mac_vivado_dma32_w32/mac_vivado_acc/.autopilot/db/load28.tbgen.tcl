...
set C_modelName {load28}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_inbuff_V int 32 regular {array 6400 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_inbuff_V", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ p_inbuff_V_we0 sc_out sc_logic 1 signal 0 } 
	{ p_inbuff_V_d0 sc_out sc_lv 32 signal 0 } 
	...
	{ mac_vec sc_in sc_lv 32 signal 2 } 
	{ mac_len sc_in sc_lv 32 signal 3 } 
	{ load_ctrl sc_out sc_lv 96 signal 4 } 
	{ load_ctrl_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ load_ctrl_ap_ack sc_in sc_logic 1 outacc 4 } 
	{ chunk sc_in sc_lv 32 signal 5 } 
	{ conf_info_mac_n sc_in sc_lv 32 signal 6 } 
	{ mac_vec_out_din sc_out sc_lv 32 signal 7 } 
	{ mac_vec_out_full_n sc_in sc_logic 1 signal 7 } 
	{ mac_vec_out_write sc_out sc_logic 1 signal 7 } 
	{ mac_len_out_din sc_out sc_lv 32 signal 8 } 
	{ mac_len_out_full_n sc_in sc_logic 1 signal 8 } 
	{ mac_len_out_write sc_out sc_logic 1 signal 8 } 
	{ chunk_out_din sc_out sc_lv 32 signal 9 } 
	{ chunk_out_full_n sc_in sc_logic 1 signal 9 } 
	{ chunk_out_write sc_out sc_logic 1 signal 9 } 
	{ conf_info_mac_n_out_din sc_out sc_lv 32 signal 10 } 
	{ conf_info_mac_n_out_full_n sc_in sc_logic 1 signal 10 } 
	{ conf_info_mac_n_out_write sc_out sc_logic 1 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_inbuff_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_inbuff_V", "role": "we0" }} , 
 	{ "name": "p_inbuff_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "p_inbuff_V", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "p_inbuff_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"},
...
set Spec2ImplPortList { 
	p_inbuff_V { ap_memory {  { p_inbuff_V_address0 mem_address 1 13 }  { p_inbuff_V_ce0 mem_ce 1 1 }  { p_inbuff_V_we0 mem_we 1 1 }  { p_inbuff_V_d0 mem_din 1 32 } } }
