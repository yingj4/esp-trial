...
set C_modelArgMapList {[ 
	{ "Name" : "out_word_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "out.word.V","cData": "int32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
 	{ "Name" : "in1_word_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in1.word.V","cData": "int32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0", "Parent" : "0", "Child" : ["2", "3", "4", "6", "7", "9", "10", "11", "12", "13", "14"],
		...
		"Port" : [
			{"Name" : "in1_word_V", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "load28_U0", "Port" : "in1_word_V"}]},
			{"Name" : "conf_info_mac_vec", "Type" : "None", "Direction" : "I"},
			{"Name" : "conf_info_mac_len", "Type" : "None", "Direction" : "I"},
			{"Name" : "load_ctrl", "Type" : "HS", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "load28_U0", "Port" : "load_ctrl"}]},
			{"Name" : "b_0", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_word_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "store_U0", "Port" : "out_word_V"}]},
			{"Name" : "conf_info_mac_n", "Type" : "None", "Direction" : "I"},
			{"Name" : "store_ctrl", "Type" : "HS", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "store_U0", "Port" : "store_ctrl"}]}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.p_inbuff_V_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.p_outbuff_V_U", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.load28_U0", "Parent" : "1", "Child" : ["5"],
		"CDFG" : "load28",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "p_inbuff_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : "6", "DependentChan" : "2"},
			{"Name" : "in1_word_V", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
			...
			{"Name" : "conf_info_mac_n", "Type" : "None", "Direction" : "I"},
			{"Name" : "mac_vec_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "6", "DependentChan" : "9",
				"BlockSignal" : [
					{"Name" : "mac_vec_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_len_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "6", "DependentChan" : "10",
				"BlockSignal" : [
					{"Name" : "mac_len_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "chunk_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "11",
				"BlockSignal" : [
					{"Name" : "chunk_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "conf_info_mac_n_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "12",
				"BlockSignal" : [
					{"Name" : "conf_info_mac_n_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "5", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.load28_U0.regslice_forward_load_ctrl_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.compute_U0", "Parent" : "1",
		"CDFG" : "compute",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "p_inbuff_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "4", "DependentChan" : "2"},
			{"Name" : "mac_vec", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "4", "DependentChan" : "9",
				"BlockSignal" : [
					{"Name" : "mac_vec_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_len", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "4", "DependentChan" : "10",
				"BlockSignal" : [
					{"Name" : "mac_len_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_outbuff_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "3"},
			{"Name" : "mac_vec_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "13",
				"BlockSignal" : [
					{"Name" : "mac_vec_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_len_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "14",
				"BlockSignal" : [
					{"Name" : "mac_len_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.store_U0", "Parent" : "1", "Child" : ["8"],
		"CDFG" : "store",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "p_outbuff_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "6", "DependentChan" : "3"},
			{"Name" : "out_word_V", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "out_word_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_n", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "4", "DependentChan" : "12",
				"BlockSignal" : [
					{"Name" : "mac_n_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_vec", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "6", "DependentChan" : "13",
				"BlockSignal" : [
					{"Name" : "mac_vec_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mac_len", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "6", "DependentChan" : "14",
				"BlockSignal" : [
					{"Name" : "mac_len_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "store_ctrl", "Type" : "HS", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "store_ctrl_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "chunk", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "4", "DependentChan" : "11",
				"BlockSignal" : [
					{"Name" : "chunk_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "8", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.store_U0.regslice_forward_store_ctrl_U", "Parent" : "7"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.conf_info_mac_vec_c_U", "Parent" : "1"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.conf_info_mac_len_c_U", "Parent" : "1"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.b_0_c_U", "Parent" : "1"},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.conf_info_mac_n_c_U", "Parent" : "1"},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.conf_info_mac_vec_c1_1_U", "Parent" : "1"},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_bat_U0.conf_info_mac_len_c2_1_U", "Parent" : "1"}]}
