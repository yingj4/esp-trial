...
(* CORE_GENERATION_INFO="mac_vivado_dma32_w32_top,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7v2000t-flg1925-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.871000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=17,HLS_SYN_DSP=18,HLS_SYN_FF=716,HLS_SYN_LUT=1422,HLS_VERSION=2019_2}" *)

module mac_vivado_dma32_w32_top (
        out_word_V_din,
        out_word_V_full_n,
        out_word_V_write,
        in1_word_V_dout,
...
wire   [31:0] dataflow_in_loop_bat_U0_out_word_V_din;
...
mac_vivado_dma32_w32_dataflow_in_loop_bat dataflow_in_loop_bat_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (*) begin
    if (((ap_start == 1'b0) & (dataflow_in_loop_bat_U0_ap_idle == 1'b1) & (loop_dataflow_output_count == 32'd0))) begin
        ap_idle = 1'b1;
    end else begin
        ap_idle = 1'b0;
    end
...
endmodule //mac_vivado_dma32_w32_top
