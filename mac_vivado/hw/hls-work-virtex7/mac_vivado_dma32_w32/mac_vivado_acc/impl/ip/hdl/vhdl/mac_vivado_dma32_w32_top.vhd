...
entity mac_vivado_dma32_w32_top is
port (
...
architecture behav of mac_vivado_dma32_w32_top is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "mac_vivado_dma32_w32_top,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7v2000t-flg1925-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.871000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=17,HLS_SYN_DSP=18,HLS_SYN_FF=716,HLS_SYN_LUT=1422,HLS_VERSION=2019_2}";
    ...
    signal dataflow_in_loop_bat_U0_out_word_V_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component mac_vivado_dma32_w32_dataflow_in_loop_bat IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        in1_word_V_dout : IN STD_LOGIC_VECTOR (31 downto 0);
...
begin
    dataflow_in_loop_bat_U0 : component mac_vivado_dma32_w32_dataflow_in_loop_bat
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if (((ap_start = ap_const_logic_0) and (dataflow_in_loop_bat_U0_ap_idle = ap_const_logic_1) and (loop_dataflow_output_count = ap_const_lv32_0))) then 
