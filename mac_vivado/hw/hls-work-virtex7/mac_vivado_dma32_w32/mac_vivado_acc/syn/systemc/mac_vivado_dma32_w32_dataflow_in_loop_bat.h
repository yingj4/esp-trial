...
#ifndef _mac_vivado_dma32_w32_dataflow_in_loop_bat_HH_
#define _mac_vivado_dma32_w32_dataflow_in_loop_bat_HH_
...
#include "mac_vivado_dma32_w32_fifo_w32_d2_A.h"
#include "mac_vivado_dma32_w32_fifo_w32_d3_A.h"

namespace ap_rtl {

struct mac_vivado_dma32_w32_dataflow_in_loop_bat : public sc_module {
    ...
    // Module declarations
    mac_vivado_dma32_w32_dataflow_in_loop_bat(sc_module_name name);
    SC_HAS_PROCESS(mac_vivado_dma32_w32_dataflow_in_loop_bat);

    ~mac_vivado_dma32_w32_dataflow_in_loop_bat();

    sc_trace_file* mVcdFile;

    mac_vivado_dma32_w32_dataflow_in_loop_bkb* p_inbuff_V_U;
    mac_vivado_dma32_w32_dataflow_in_loop_cud* p_outbuff_V_U;
    ...
    sc_signal< sc_lv<32> > p_inbuff_V_i_q0;
    sc_signal< sc_lv<32> > p_inbuff_V_i_q1;
    sc_signal< sc_lv<32> > p_inbuff_V_t_q0;
    sc_signal< sc_lv<32> > p_inbuff_V_t_q1;
    sc_signal< sc_lv<32> > p_outbuff_V_i_q0;
    sc_signal< sc_lv<32> > p_outbuff_V_t_q0;
    sc_signal< sc_logic > load28_U0_ap_start;
    sc_signal< sc_logic > load28_U0_ap_done;
    sc_signal< sc_logic > load28_U0_ap_continue;
    sc_signal< sc_logic > load28_U0_ap_idle;
    sc_signal< sc_logic > load28_U0_ap_ready;
    sc_signal< sc_lv<13> > load28_U0_p_inbuff_V_address0;
    sc_signal< sc_logic > load28_U0_p_inbuff_V_ce0;
    sc_signal< sc_logic > load28_U0_p_inbuff_V_we0;
    sc_signal< sc_lv<32> > load28_U0_p_inbuff_V_d0;
    sc_signal< sc_logic > load28_U0_in1_word_V_read;
    sc_signal< sc_lv<96> > load28_U0_load_ctrl;
    sc_signal< sc_logic > load28_U0_load_ctrl_ap_vld;
    sc_signal< sc_lv<32> > load28_U0_mac_vec_out_din;
    sc_signal< sc_logic > load28_U0_mac_vec_out_write;
    sc_signal< sc_lv<32> > load28_U0_mac_len_out_din;
    sc_signal< sc_logic > load28_U0_mac_len_out_write;
    sc_signal< sc_lv<32> > load28_U0_chunk_out_din;
    sc_signal< sc_logic > load28_U0_chunk_out_write;
    sc_signal< sc_lv<32> > load28_U0_conf_info_mac_n_out_din;
    sc_signal< sc_logic > load28_U0_conf_info_mac_n_out_write;
    sc_signal< sc_logic > ap_channel_done_p_inbuff_V;
    sc_signal< sc_logic > load28_U0_p_inbuff_V_full_n;
    sc_signal< sc_logic > ap_sync_reg_channel_write_p_inbuff_V;
    sc_signal< sc_logic > ap_sync_channel_write_p_inbuff_V;
    ...
    sc_signal< sc_lv<13> > compute_U0_p_inbuff_V_address0;
    sc_signal< sc_logic > compute_U0_p_inbuff_V_ce0;
    sc_signal< sc_lv<13> > compute_U0_p_inbuff_V_address1;
    sc_signal< sc_logic > compute_U0_p_inbuff_V_ce1;
    sc_signal< sc_logic > compute_U0_mac_vec_read;
    sc_signal< sc_logic > compute_U0_mac_len_read;
    sc_signal< sc_lv<7> > compute_U0_p_outbuff_V_address0;
    sc_signal< sc_logic > compute_U0_p_outbuff_V_ce0;
    sc_signal< sc_logic > compute_U0_p_outbuff_V_we0;
    sc_signal< sc_lv<32> > compute_U0_p_outbuff_V_d0;
    ...
    sc_signal< sc_logic > ap_channel_done_p_outbuff_V;
    sc_signal< sc_logic > compute_U0_p_outbuff_V_full_n;
    ...
    sc_signal< sc_lv<7> > store_U0_p_outbuff_V_address0;
    sc_signal< sc_logic > store_U0_p_outbuff_V_ce0;
    sc_signal< sc_lv<32> > store_U0_out_word_V_din;
    ...
    sc_signal< sc_logic > p_inbuff_V_i_full_n;
    sc_signal< sc_logic > p_inbuff_V_t_empty_n;
    sc_signal< sc_lv<32> > p_inbuff_V_t_d1;
    sc_signal< sc_logic > p_inbuff_V_t_we1;
    sc_signal< sc_logic > p_outbuff_V_i_full_n;
    sc_signal< sc_logic > p_outbuff_V_t_empty_n;
    ...
    sc_signal< sc_logic > load28_U0_start_full_n;
    sc_signal< sc_logic > load28_U0_start_write;
    ...
    void thread_ap_channel_done_p_inbuff_V();
    void thread_ap_channel_done_p_outbuff_V();
    void thread_ap_done();
    void thread_ap_idle();
    void thread_ap_ready();
    void thread_ap_sync_channel_write_p_inbuff_V();
    void thread_ap_sync_continue();
    void thread_ap_sync_done();
    void thread_ap_sync_ready();
    void thread_compute_U0_ap_continue();
    void thread_compute_U0_ap_start();
    void thread_compute_U0_p_outbuff_V_full_n();
    void thread_compute_U0_start_full_n();
    void thread_compute_U0_start_write();
    void thread_in1_word_V_read();
    void thread_load28_U0_ap_continue();
    void thread_load28_U0_ap_start();
    void thread_load28_U0_p_inbuff_V_full_n();
    void thread_load28_U0_start_full_n();
    void thread_load28_U0_start_write();
    void thread_load_ctrl();
    void thread_load_ctrl_ap_vld();
    void thread_out_word_V_din();
    void thread_out_word_V_write();
    void thread_p_inbuff_V_t_d1();
    void thread_p_inbuff_V_t_we1();
