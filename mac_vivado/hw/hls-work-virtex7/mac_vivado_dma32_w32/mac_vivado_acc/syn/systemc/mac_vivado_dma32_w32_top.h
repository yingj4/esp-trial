...
#ifndef _mac_vivado_dma32_w32_top_HH_
#define _mac_vivado_dma32_w32_top_HH_
...
struct mac_vivado_dma32_w32_top : public sc_module {
    ...
    // Module declarations
    mac_vivado_dma32_w32_top(sc_module_name name);
    SC_HAS_PROCESS(mac_vivado_dma32_w32_top);
    ...
    sc_signal< sc_lv<32> > dataflow_in_loop_bat_U0_out_word_V_din;
