...
// Date        : Sun Mar 28 16:25:45 2021
// Host        : mojave.cs.illinois.edu running 64-bit CentOS Linux release 7.9.2009 (Core)
// Command     : write_verilog -cell inst_2 -force
//               /scratch/projects/yingj4/esp/accelerators/stratus_hls/mac_stratus/hw/hls-work-virtex7/bdw_work/modules/mac/BASIC_DMA64/v_gates/mac_Add_14Sx1U_14S_4.v
// Design      : mac_Add_14Sx1U_14S_4
...
module mac_Add_14Sx1U_14S_4
  ...
  CARRY4 \out1[12]_INST_0 
       (.CI(\out1[8]_INST_0_n_0 ),
        .CO(\out1[12]_INST_0_n_3 ),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(out1[13:12]),
        .S({\<const0> ,\<const0> ,in2[13:12]}));
