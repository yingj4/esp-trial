...
#if ! defined mac_plm_block_in_dma32_CC
#define mac_plm_block_in_dma32_CC 1
...
#include "mac_plm_block_in_dma32.h"
...
#ifdef STRATUS_HLS
   sc_uint<32> mac_plm_block_in_dma32::write0(sc_uint<13> A0, sc_uint<32> D0, bool WE0, bool CE0, sc_uint<32> WEM0) {
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   void mac_plm_block_in_dma32::nop0(bool WE0, bool CE0, sc_uint<32> WEM0) {
      CYN_BIND(WE0,this->WE0);
      CYN_BIND(CE0,this->CE0);
      CYN_BIND(WEM0,this->WEM0);
      HLS_CONFIG_INSTRUCTION( "access_port", 1 );
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   sc_uint<32> mac_plm_block_in_dma32::read1(sc_uint<13> A1, bool CE1) {
      sc_uint<32> Q1;
      CYN_BIND(A1,this->A1);
      CYN_BIND(Q1,this->Q1);
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   void mac_plm_block_in_dma32::nop1(bool CE1) {
      CYN_BIND(CE1,this->CE1);
      HLS_CONFIG_INSTRUCTION( "access_port", 2 );
   }

#endif	// STRATUS_HLS
   void mac_plm_block_in_dma32::thread0() {
   ...
   void mac_plm_block_in_dma32::thread1() {
#if defined(__GNUC__) && BDW_USE_SCV
   ...
   mac_plm_block_in_dma32::mac_plm_block_in_dma32(const sc_module_name name)
      : sc_module( name ) ,CLK("CLK"),WE0("WE0"),CE0("CE0"),D0("D0"),A0("A0"),WEM0("WEM0"),CE1("CE1"),Q1("Q1"),A1("A1"), mem()
#else
   mac_plm_block_in_dma32::mac_plm_block_in_dma32( sc_module_name name)
      : sc_module( name ) ,CLK("CLK"),WE0("WE0"),CE0("CE0"),D0("D0"),A0("A0"),WEM0("WEM0"),CE1("CE1"),Q1("Q1"),A1("A1"), mem() 
#if defined(__GNUC__) 
...
const unsigned long mac_plm_block_in_dma32::implemented = 1;
const unsigned long mac_plm_block_in_dma32::pipelined = 0;
const float mac_plm_block_in_dma32::area = 13.0;
const float mac_plm_block_in_dma32::delay = 0.2;
const float mac_plm_block_in_dma32::setup_time = 0.06;
const unsigned long mac_plm_block_in_dma32::latency_WE0 = 1;
const unsigned long mac_plm_block_in_dma32::latency_WEM0 = 1;
const unsigned long mac_plm_block_in_dma32::latency_CE0 = 1;
const unsigned long mac_plm_block_in_dma32::latency_D0 = 1;
const unsigned long mac_plm_block_in_dma32::latency_A0 = 1;
const unsigned long mac_plm_block_in_dma32::bits_per_maskbit_WEM0 = 1;
const unsigned long mac_plm_block_in_dma32::latency_CE1 = 1;
const unsigned long mac_plm_block_in_dma32::latency_A1 = 1;
const unsigned long mac_plm_block_in_dma32::bits_per_maskbit_WM1 = 0;
const unsigned long mac_plm_block_in_dma32::reg_mem_inputs = 0;
const unsigned long mac_plm_block_in_dma32::reg_mem_outputs = 0;
const unsigned long mac_plm_block_in_dma32::regs_at_mem_inputs = 0;
const unsigned long mac_plm_block_in_dma32::regs_at_mem_outputs = 0;
const unsigned long mac_plm_block_in_dma32::no_spec_reads = 1;
const unsigned long mac_plm_block_in_dma32::is_mem = 1;
const unsigned long mac_plm_block_in_dma32::clock_multiplier = 0;
const bool mac_plm_block_in_dma32::has_extra_ports = false;
const bool mac_plm_block_in_dma32::is_prototype = false;
const char* mac_plm_block_in_dma32::naming_convention = 0;
 
#endif // mac_plm_block_in_dma32_CC
