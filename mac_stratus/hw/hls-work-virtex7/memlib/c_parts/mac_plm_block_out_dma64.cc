...
#if ! defined mac_plm_block_out_dma64_CC
#define mac_plm_block_out_dma64_CC 1
...
#include "mac_plm_block_out_dma64.h"
...
#ifdef STRATUS_HLS
   sc_uint<32> mac_plm_block_out_dma64::write0(sc_uint<7> A0, sc_uint<32> D0, bool WE0, bool CE0, sc_uint<32> WEM0) {
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   void mac_plm_block_out_dma64::nop0(bool WE0, bool CE0, sc_uint<32> WEM0) {
      CYN_BIND(WE0,this->WE0);
      CYN_BIND(CE0,this->CE0);
      CYN_BIND(WEM0,this->WEM0);
      HLS_CONFIG_INSTRUCTION( "access_port", 1 );
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   sc_uint<32> mac_plm_block_out_dma64::read1(sc_uint<7> A1, bool CE1) {
      sc_uint<32> Q1;
      CYN_BIND(A1,this->A1);
      CYN_BIND(Q1,this->Q1);
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   void mac_plm_block_out_dma64::nop1(bool CE1) {
      CYN_BIND(CE1,this->CE1);
      HLS_CONFIG_INSTRUCTION( "access_port", 2 );
   }
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   sc_uint<32> mac_plm_block_out_dma64::read2(sc_uint<7> A2, bool CE2) {
      sc_uint<32> Q2;
      CYN_BIND(A2,this->A2);
      CYN_BIND(Q2,this->Q2);
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   void mac_plm_block_out_dma64::nop2(bool CE2) {
      CYN_BIND(CE2,this->CE2);
      HLS_CONFIG_INSTRUCTION( "access_port", 3 );
   }

#endif	// STRATUS_HLS
   void mac_plm_block_out_dma64::thread0() {
   ...
   void mac_plm_block_out_dma64::thread1() {
#if defined(__GNUC__) && BDW_USE_SCV
   ...
   void mac_plm_block_out_dma64::thread2() {
#if defined(__GNUC__) && BDW_USE_SCV
   ...
   mac_plm_block_out_dma64::mac_plm_block_out_dma64(const sc_module_name name)
      : sc_module( name ) ,CLK("CLK"),WE0("WE0"),CE0("CE0"),D0("D0"),A0("A0"),WEM0("WEM0"),CE1("CE1"),Q1("Q1"),A1("A1"),CE2("CE2"),Q2("Q2"),A2("A2"), mem()
#else
   mac_plm_block_out_dma64::mac_plm_block_out_dma64( sc_module_name name)
      : sc_module( name ) ,CLK("CLK"),WE0("WE0"),CE0("CE0"),D0("D0"),A0("A0"),WEM0("WEM0"),CE1("CE1"),Q1("Q1"),A1("A1"),CE2("CE2"),Q2("Q2"),A2("A2"), mem() 
#if defined(__GNUC__) 
...
const unsigned long mac_plm_block_out_dma64::implemented = 1;
const unsigned long mac_plm_block_out_dma64::pipelined = 0;
const float mac_plm_block_out_dma64::area = 1.0;
const float mac_plm_block_out_dma64::delay = 0.2;
const float mac_plm_block_out_dma64::setup_time = 0.06;
const unsigned long mac_plm_block_out_dma64::latency_WE0 = 1;
const unsigned long mac_plm_block_out_dma64::latency_WEM0 = 1;
const unsigned long mac_plm_block_out_dma64::latency_CE0 = 1;
const unsigned long mac_plm_block_out_dma64::latency_D0 = 1;
const unsigned long mac_plm_block_out_dma64::latency_A0 = 1;
const unsigned long mac_plm_block_out_dma64::bits_per_maskbit_WEM0 = 1;
const unsigned long mac_plm_block_out_dma64::latency_CE1 = 1;
const unsigned long mac_plm_block_out_dma64::latency_A1 = 1;
const unsigned long mac_plm_block_out_dma64::bits_per_maskbit_WM1 = 0;
const unsigned long mac_plm_block_out_dma64::latency_CE2 = 1;
const unsigned long mac_plm_block_out_dma64::latency_A2 = 1;
const unsigned long mac_plm_block_out_dma64::bits_per_maskbit_WM2 = 0;
const unsigned long mac_plm_block_out_dma64::reg_mem_inputs = 0;
const unsigned long mac_plm_block_out_dma64::reg_mem_outputs = 0;
const unsigned long mac_plm_block_out_dma64::regs_at_mem_inputs = 0;
const unsigned long mac_plm_block_out_dma64::regs_at_mem_outputs = 0;
const unsigned long mac_plm_block_out_dma64::no_spec_reads = 1;
const unsigned long mac_plm_block_out_dma64::is_mem = 1;
const unsigned long mac_plm_block_out_dma64::clock_multiplier = 0;
const bool mac_plm_block_out_dma64::has_extra_ports = false;
const bool mac_plm_block_out_dma64::is_prototype = false;
const char* mac_plm_block_out_dma64::naming_convention = 0;
 
#endif // mac_plm_block_out_dma64_CC
